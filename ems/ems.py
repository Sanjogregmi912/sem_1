...
button_login=Button(frame_title,text="LOGIN",height=3,width=30)
...
def register():
    ...
    def add_to_database():
        ...
        # insert to the table
        c.execute(
            "INSERT INTO registration VALUES( :First_name, :Last_name,:gender, :address, :citizenship_number, :nationality, :experience, :father_name,:phone_number,:email_address,:password)",
            {
...
# labels in the frame
    ...
    email_address_label = Label(frame1, text="Email Address")
...
# adding entry
    ...
    email_address = Entry(frame1, width=30)
